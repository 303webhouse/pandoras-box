# TRITON — HOLDOUT RESIDUE CENSUS · 2026-09-01

**Author:** CC-QUERY · **Read-only.** Re-filed from the registration artifact per
R-IV.140 (relayed R-IV.145): the census is results, not a pre-registration, and belongs
under `docs/edge/results/`.

Residue is **disjoint from the holdout** by construction (fired < 08-17 vs ≥ 08-17), so
no no-peek constraint applies to any of it.

Registration of record: `docs/edge/preregistrations/triton-holdout-registration-2026-09-01.md`
