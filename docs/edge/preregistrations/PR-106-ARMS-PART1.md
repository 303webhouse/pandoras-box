...
**B2 IS THE ONLY CONFOUND-FREE ARM.** It compares an instrument against ITSELF at a fixed 20-trading-day horizon, so direction cancels regardless of composition. B2 reads cleanly in every cell — and shows no consistent pattern: metals +5.54 (6/8 excl ZW) and OTHER +2.00 (11/17) positive; semis −0.53 (7/14), energy −0.57 (4/7), crypto −7.61 (3/7) negative-to-neutral.
