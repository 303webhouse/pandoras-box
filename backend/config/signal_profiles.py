...
RR_PROFILES = {
    ...
    # NOTE: Scanner produces TRANSITION zone labels; legacy RECOVERY mappings were replaced (2026-02).
    ("GOLDEN_TOUCH", "TRANSITION"): (1.25, 2.5),
    ("GOLDEN_TOUCH", "DE_LEVERAGING"): (1.5, 2.0),

    # PULLBACK_ENTRY: Deeper pullback to 50 SMA
    ("PULLBACK_ENTRY", "MAX_LONG"): (1.25, 3.0),
    ("PULLBACK_ENTRY", "TRANSITION"): (1.5, 2.5),
    ...
    ("TRAPPED_SHORTS", "TRANSITION"): (1.25, 3.0),
}
