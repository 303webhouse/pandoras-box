...
DESCRIPTION = (
    ...
    "and implied volatility. Plus chain-level aggregates: spot, IV rank "
    "(0-100), max pain (filtered to the requested expiry), total call/put "
    "open interest, and the UW server timestamp + source flag.\n\n"
    "NOTE — Greeks deferred (v1.5): per-contract delta/gamma/theta/vega are "
    "NOT in this version. UW's /option-contracts endpoint does not return "
    "them. DAEDALUS continues in qualitative-Greeks-mode; a Tier 2 follow-up "
    "brief will add Greeks via Black-Scholes computation or an alternate "
    "provider. IV rank and per-contract implied_volatility ARE quantitative "
    "in v1.5 — the IV side of the qualitative-IV-mode caveat is now closed.\n\n"
    ...
    "strike picking, liquidity check, IV-regime read). "
    ...
    "call this for historical option pricing (out of v1.5 scope).\n\n"
